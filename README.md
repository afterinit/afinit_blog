...
## CLoudflare IA文字合法性检验

- 获取用户id

  1. 打开CLoudflare点击`...`选择复制账户ID

     ![image-20260615193503119](https://img.afinit.top/image/image-20260615193503119.png)

- 获取账户API令牌

  1. 打开CLoudflare点击个人头像，选择配置文件

     ![image-20260615193656121](https://img.afinit.top/image/image-20260615193656121.png)

  2. 点击API令牌，点击创建令牌

     ![image-20260615193913708](https://img.afinit.top/image/image-20260615193913708.png)

  3. 选择`Workers AI`使用模板，权限只需要读取即可，账户资源选择包括，选择自己的账户，点击继续以显示摘要，随后创建令牌

     ![image-20260615194243816](https://img.afinit.top/image/image-20260615194243816.png)
...
- yml配置
  ...
  ```yaml
    ai:
      ...
      url: https://api.cloudflare.com/client/v4/accounts/${cloudflare.ai.account-id}/ai/run/@cf/meta/llama-guard-3-8b
  ```
