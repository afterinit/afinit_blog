...
import top.afinit.common.result.*;
...
public class UserController {
    ...
    public Result<LoginTokenVO> login(@RequestBody @Validated UserLoginDTO userLoginDTO,
                                      @RequestHeader(value = HttpConstants.CLIENT_TYPE,
                                              required = false,
                                              defaultValue = HttpConstants.Param.WEB)
                                      String clientType){
    ...
    @PostMapping("/refresh")
    public Result<LoginTokenVO> refresh(@RequestHeader(value = HttpConstants.REFRESH_HEADER,required = false)
        ...
        return Result.success(AuthResultCode.AUTH_REFRESH_OK,loginTokenVO);
    ...
    public Result<Void> getCodeByEmail(@RequestBody @Validated SendCodeDTO sendCodeDTO){
        ...
        return Result.success(VerResultCode.SEND_CODE_OK);
    }
